#!/usr/bin/env bash
# Script baseado no https://github.com/KingOfBugbounty/DockerHunt
# Modificado por Luciano Domingues a.k.a. }-SiRi-{
# 05.09.2023

# [TODO] validar scripts a serem instalados
...
sudo apt update
sudo apt install /tmp/rustscan.deb
rm /tmp/rustscan.deb
sleep 1
